...
use crate::old::asset_management::AssetID;
use crate::old::card_pile::NewCard;
use crate::old::grid::Grid;
use crate::old::mouse::MousePosition;
use crate::old::shape::{Geometry, Shape};
use crate::old::util::{contains_point, min_f};
use crate::old::{asset_management::AssetManager, grid::Cultivation};
use crate::old::{GRID_OFFSET, GRID_SIZE, SPRITE_SIZE};
...
pub fn click_card(
    ...
    mut clicks: Res<Input<MouseButton>>,
